...
class DeepPhyLSTM(nn.Module):
    ...
    def train(self, num_epochs, learning_rate, bfgs=False):
        ...
        # Adam training phase
        print("\nStarting Adam optimization with PCGrad...")
        ...
        # L-BFGS training phase (without PCGrad)
        if bfgs:
            print("\nStarting L-BFGS optimization (without PCGrad)...")
